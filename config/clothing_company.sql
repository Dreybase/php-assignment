...
(1, 'Odeyemi Damilare', 'Dreybase', '12, ilupeju street, oke-odo, Ilaro.'),
(2, 'Siyanbade Waliu', 'Waliu002', 'No. 98, lafenwa road, soyoye housing estate, soyoye, Abeokuta'),
(3, 'Adeola Adeniyi', 'Hardext', 'UAMC Eleja primary school, Pahayi, Ilaro'),
(4, 'Odeniyi Adeola', 'Odes001', '32, Oladunni street, oke-ata, abeokuta');
